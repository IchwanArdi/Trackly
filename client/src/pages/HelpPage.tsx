...
import { Search, ChevronDown, Mail, FileText, Shield, Trash2 } from 'lucide-react';
            ...
            <div className="mx-auto max-w-2xl px-6 py-10 sm:px-8">
                ...
                <div className="mb-10 rounded-lg border border-border bg-card px-4">
                    {filteredFaqs.length > 0 ? (
                        ...
                        <p className="py-6 text-center text-sm text-muted">Tidak ada hasil untuk "{query}"</p>
                    )}
                </div>
                ...
                <div className="mb-10 rounded-lg border border-border bg-card p-5">
                    ...
                    <a
                        ...
                        className="mt-4 inline-flex items-center gap-2 rounded-md border border-border px-4 py-2 text-sm font-medium text-foreground transition hover:bg-surface"
                    >
                        <Mail size={14} />
                ...
                <div className="grid grid-cols-1 gap-2 sm:grid-cols-3">
                    <Link
                        to="/terms-of-service"
                        className="flex items-center gap-2.5 rounded-md border border-border bg-card px-4 py-3 text-sm text-muted transition hover:text-foreground hover:bg-surface"
                    >
                        <FileText size={14} />
                        Terms of Service
                    </Link>
